...
public class AddNightLife {

    private User admin;

    public AddNightLife(User admin) {
        this.admin = admin;
    }
    ...
    public void show(Stage st) {
        ...
        Label type = new Label("Type of nightlife: ");
        ...
        create.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                if (naField.getText() != null && nodeNoField.getText() != null
                    ...
                    loc.addLoc(new model.base.Nightlife(naField.getText(), Integer.parseInt(nodeNoField.getText()),
