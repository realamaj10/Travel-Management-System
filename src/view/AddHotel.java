...
public class AddHotel {
    ...
    public void show(Stage st) {
        ...
        stars.setFont(Font.font("Book Antiqua",
                FontWeight.BOLD, 18));
        stars.setTextFill(Color.CADETBLUE);
        ...
        HBox bx3 = new HBox();
        bx3.getChildren().addAll(stars, starField);
        bx3.setSpacing(5);
        ...
        create.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                if (naField.getText() != null && nodeNoField.getText() != null
                        && desField.getText() != null && starField.getText() != null) {

                    LocationRW loc = new LocationRW();
                    loc.addLoc(new model.base.Hotel(naField.getText(), Integer.parseInt(nodeNoField.getText()),
                            desField.getText(), Integer.parseInt(starField.getText())));
