...
public class AddOutdoorActivity {

    private User admin;

    public AddOutdoorActivity(User admin) {
        this.admin = admin;
    }
    ...
    public void show(Stage st) {
        ...
        Label attraction = new Label("Attractions: ");
        attraction.setFont(Font.font("Book Antiqua",
                FontWeight.BOLD, 18));
        attraction.setTextFill(Color.CADETBLUE);
        Label activities = new Label("Activities: ");
        activities.setFont(Font.font("Book Antiqua",
                FontWeight.BOLD, 18));
        activities.setTextFill(Color.CADETBLUE);
        ...
        HBox bx2 = new HBox();
        bx2.getChildren().addAll(attraction, attrField);
        bx2.setSpacing(5);
        bx2.setAlignment(Pos.CENTER);

        HBox bx3 = new HBox();
        bx3.getChildren().addAll(nodeNo, nodeNoField);
        bx3.setSpacing(5);
        bx3.setAlignment(Pos.CENTER);

        HBox bx4 = new HBox();
        bx4.getChildren().addAll(des, desField);
        bx4.setSpacing(5);
        bx2.setAlignment(Pos.CENTER);

        HBox bx5 = new HBox();
        bx5.getChildren().addAll(activities, actField);
        bx5.setSpacing(5);
        ...
        VBox vb = new VBox();
        vb.getChildren().addAll(bx1, bx2, bx3, bx4, bx5, bx7);
        vb.setSpacing(5);
        ...
        st.setScene(sc);
        st.setTitle("Add Outdoor Activity");
        ...
        create.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent arg0) {
                if (naField.getText() != null && nodeNoField.getText() != null
                        && desField.getText() != null && attrField.getText() != null && actField.getText() != null) {

                    LocationRW loc = new LocationRW();
                    loc.addLoc(new model.base.Outdoor_Activity(naField.getText(), Integer.parseInt(nodeNoField.getText()),
                            desField.getText(), attrField.getText(), actField.getText()));
